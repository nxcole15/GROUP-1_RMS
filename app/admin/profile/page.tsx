...
const INITIAL_PROFILE: AdminProfileData = {
  id: "ADM001",
  name: "Admin User",
  email: "admin@cfei.edu",
  phone: "+63 920 123 4567",
  address: "789 Cebu City, Cebu",
  role: "Administrator",
...
export default function AdminProfilePage() {
  ...
  return (
    <div className="d-flex" style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      {/* Main Content - Using existing admin dashboard sidebar */}
            ...
            <div className="col-12 col-lg-4">
              <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div className="card-body p-0">
                  {/* Cover */}
                  <div className="position-relative" style={{ height: "120px", background: "linear-gradient(135deg, #7c3aed, #a855f7)" }}>
                        ...
                        {editMode && (
                          <>
                            <button
                              ...
                              style={{ width: 36, height: 36, padding: 0, background: "#7c3aed", color: "white", border: "none" }}
                              title="Change photo"
                            >
                              📷
                            </button>
                  ...
                  <div className="pt-5 mt-4 px-4 pb-4 text-center">
                    ...
                    <div className="d-flex justify-content-center gap-2 mb-4">
                      <span className="badge rounded-pill px-3 py-2" style={{ background: "linear-gradient(135deg, #7c3aed, #a855f7)", color: "white" }}>
                        {profile.role}
                      </span>
                    ...
                    <div className="row g-3">
                      <div className="col-6">
                        <div className="rounded-3 p-3 bg-light border">
                          ...
                          <div className="fw-bold small" style={{ color: "#7c3aed" }}>{new Date(profile.hireDate).getFullYear()}</div>
                        </div>
                      </div>
                      <div className="col-6">
                        <div className="rounded-3 p-3 bg-light border">
                          <div className="text-muted small mb-1">Status</div>
                          <div className="fw-bold small" style={{ color: "#7c3aed" }}>Active</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    {!editMode ? (
                      <button onClick={() => setEditMode(true)} className="btn px-4" style={{ background: "#7c3aed", color: "white", border: "none" }}>
                        ✏️ Edit Profile
                      </button>
                    ) : (
                      <div className="d-flex gap-2">
                        ...
                        <button onClick={handleSave} disabled={loading} className="btn px-4" style={{ background: "#7c3aed", color: "white", border: "none" }}>
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-12 col-md-6">
                      <label className="form-label fw-semibold small text-uppercase text-muted">Admin ID</label>
                    ...
                    <div className="col-12 col-md-6">
                      <label className="form-label fw-semibold small text-uppercase text-muted">Role</label>
                      <input type="text" className="form-control" value={profile.role} disabled style={{ background: "#f1f5f9" }} />
                    </div>
                    <div className="col-12 col-md-6">
